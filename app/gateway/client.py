...
# This Portkey account has inline configs disabled, so the config above lives as a
# saved Config in the Portkey dashboard and is referenced here by its slug.
GATEWAY_CONFIG = "pc-projec-0892da"
