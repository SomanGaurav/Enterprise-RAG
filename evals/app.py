...
# nest_asyncio cannot patch a uvloop loop (raises "Can't patch loop of type
# <uvloop.Loop>"). uvloop is pulled in via uvicorn[standard]. Force a genuine
# stdlib asyncio loop for this Streamlit process and patch that loop explicitly.
import selectors
asyncio.set_event_loop_policy(asyncio.DefaultEventLoopPolicy())
_eval_loop = asyncio.SelectorEventLoop(selectors.DefaultSelector())
